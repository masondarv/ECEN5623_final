...
void *ImgProc_Service(void *threadp)
{
	...
	while(!exit_flag)
	{
		...
		threshold(RGB[2],RGB[2],190,255,THRESH_BINARY_INV);
		//threshold(RGB[2],RGB[2],170,255,THRESH_BINARY);
		threshold(RGB[1],RGB[1],160,255,THRESH_BINARY);
